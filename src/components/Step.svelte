...
<a
    href={step.href}
    target="_blank"
    class="p-4 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-solid border-red-700 text-center cursor-pointer group hover:border-red-400 duration-200"
>
    <div
    ...
    <div class="flex-1 flex justify-betweeen gap-4 items-end">
        <a href="https://github.com/Sammieblz">
            <div
